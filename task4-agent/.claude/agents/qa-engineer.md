...
*Taken from the [Constellize QA Engineer persona](https://github.com/constellize/marketplace/blob/main/plugins/constellize-quality/agents/qa-engineers.md)*
...
## ACCEPTANCE CRITERIA — Command-Line Quiz Application

These acceptance criteria define the testable requirements for the quiz application.

### AC-1: Question Creation
- GIVEN a user provides a question prompt and answer
- WHEN a Question object is created
- THEN it stores the prompt and answer as accessible attributes

### AC-2: Question Serialization
- GIVEN a Question object with prompt "What is 2+2?" and answer "4"
- WHEN to_dict() is called
- THEN it returns {"prompt": "What is 2+2?", "answer": "4"}

### AC-3: Question Deserialization
- GIVEN a dictionary {"prompt": "Capital of France?", "answer": "Paris"}
- WHEN Question.from_dict() is called
- THEN it returns a Question with matching prompt and answer attributes

### AC-4: Quiz Storage
- GIVEN a list of Question objects and quiz name "myquiz"
- WHEN save_quiz() is called
- THEN a file "myquiz.json" is created containing the serialized questions as valid JSON

### AC-5: Quiz Loading (Exists)
- GIVEN a quiz file "myquiz.json" exists with valid question data
- WHEN load_quiz("myquiz") is called
- THEN it returns a list of Question objects matching the saved data

### AC-6: Quiz Loading (Missing File)
- GIVEN no file named "ghost.json" exists
- WHEN load_quiz("ghost") is called
- THEN it returns an empty list and prints an error message

### AC-7: Quiz Scoring (Correct)
- GIVEN a quiz with one question whose answer is "Paris"
- WHEN the user inputs "Paris"
- THEN the score increments by 1 and "Correct!" is printed

### AC-8: Quiz Scoring (Wrong)
- GIVEN a quiz with one question whose answer is "Paris"
- WHEN the user inputs "London"
- THEN the score does not increment and the correct answer is displayed

### AC-9: Case-Insensitive Matching
- GIVEN a question with answer "Paris"
- WHEN the user inputs "paris", "PARIS", or "pArIs"
- THEN all are marked as correct

### AC-10: Final Score Display
- GIVEN a quiz of 3 questions where the user answers 2 correctly
- WHEN the quiz completes
- THEN "Your final score is 2/3" is printed

### AC-11: Quiz Randomization
- GIVEN a quiz with multiple questions
- WHEN the quiz is taken
- THEN questions are presented in a shuffled order

### AC-12: Interactive Quiz Creation
- GIVEN a user enters questions interactively and types "done"
- WHEN create_quiz() is called
- THEN all entered questions are saved to a named JSON file

### AC-13: Main Menu Navigation
- GIVEN the main menu is displayed
- WHEN the user enters "1", "2", or "3"
- THEN the corresponding action executes (take quiz, create quiz, or exit)

### AC-14: Invalid Menu Choice
- GIVEN the main menu is displayed
- WHEN the user enters an invalid choice (e.g., "7" or "abc")
- THEN an error message is printed and the menu re-displays
---
